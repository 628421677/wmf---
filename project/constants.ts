...
export const MOCK_PROJECTS: Project[] = [
  ...
  {
    id: 'PRJ-2024-002',
    name: '旗山校区信息化中心机房改造工程',
    contractAmount: 3200000,
    contractor: '福建省电子信息工程有限公司',
    status: AssetStatus.DisposalPending,
    completionDate: '2024-09-30',
    hasCadData: false,
    fundSource: FundSource.SelfRaised,
    location: '旗山校区行政办公大楼B1',
    plannedArea: 600,
    floorCount: 1,
    roomCount: 8,
    ...
    projectManager: '陈工',
    supervisor: '福州建科监理有限公司',
    milestones: [
      { milestone: ProjectMilestone.Approval, date: '2024-01-15', operator: '信息化中心', notes: '校内立项批复' },
      { milestone: ProjectMilestone.Bidding, date: '2024-02-20', operator: '招标办', notes: '比选完成' },
      { milestone: ProjectMilestone.Construction, date: '2024-03-10', operator: '基建处', notes: '进场施工' },
      { milestone: ProjectMilestone.Completion, date: '2024-09-30', operator: '基建处', notes: '竣工验收通过' },
    ],
    attachments: [
      { id: 'ATT-2024-002-1', name: '立项批复.pdf', type: 'approval', uploadDate: '2024-01-20', uploadedByDept: '信息化中心', reviewStatus: 'Pending' as any },
      { id: 'ATT-2024-002-2', name: '施工合同.pdf', type: 'contract', uploadDate: '2024-02-25', uploadedByDept: '招标办', reviewStatus: 'Pending' as any },
    ],
    splitItems: [],
    gaojibiaoData: {},
    isOverdue: false,
  ...
  {
    id: 'PRJ-2023-006',
    name: '旗山校区教学楼A区消防改造工程',
    contractAmount: 4800000,
    auditAmount: 4650000,
    auditReductionRate: 3.13,
    contractor: '福建安盾消防工程有限公司',
    ...
    actualStartDate: '2023-06-10',
    actualEndDate: '2023-12-15',
    projectManager: '黄工',
    supervisor: '福建省建设监理有限公司',
    milestones: [
      { milestone: ProjectMilestone.Approval, date: '2023-04-10', operator: '保卫处', notes: '消防整改立项' },
      { milestone: ProjectMilestone.Bidding, date: '2023-05-20', operator: '招标办', notes: '公开招标完成' },
      { milestone: ProjectMilestone.Construction, date: '2023-06-10', operator: '基建处', notes: '开工' },
      { milestone: ProjectMilestone.Completion, date: '2023-12-15', operator: '基建处', notes: '验收完成' },
      { milestone: ProjectMilestone.Transfer, date: '2024-01-05', operator: '基建处', notes: '提交转固申请' },
    ],
    attachments: [
      { id: 'ATT-2023-006-1', name: '竣工验收报告.pdf', type: 'acceptance', uploadDate: '2023-12-20', uploadedByDept: '基建处', reviewStatus: 'Pending' as any },
      { id: 'ATT-2023-006-2', name: '审计报告.pdf', type: 'audit', uploadDate: '2024-01-02', uploadedByDept: '审计处', reviewStatus: 'Pending' as any },
    ],
    splitItems: [
      { id: 'SPLIT-2023-006-1', category: AssetCategory.Other, name: '消防系统改造', amount: 4650000, depreciationYears: 10, depreciationMethod: 'StraightLine' as any },
    ],
    gaojibiaoData: {},
    isOverdue: true,
    overduedays: 30,
  ...
  // 待归档：附件已全部通过（或视为已具备归档条件），等待归档
  {
    id: 'PRJ-2024-001',
    name: '旗山校区综合体育馆屋面防水修缮工程',
    contractAmount: 5600000,
    auditAmount: 5520000,
    auditReductionRate: 1.43,
    contractor: '福建省建工修缮有限公司',
    ...
    projectManager: '林工',
    supervisor: '福州市建设工程监理有限公司',
    milestones: [
      { milestone: ProjectMilestone.Approval, date: '2024-03-10', operator: '后勤管理处', notes: '修缮立项' },
      { milestone: ProjectMilestone.Bidding, date: '2024-04-20', operator: '招标办', notes: '比选完成' },
      { milestone: ProjectMilestone.Construction, date: '2024-05-05', operator: '基建处', notes: '开工' },
      { milestone: ProjectMilestone.Completion, date: '2024-08-18', operator: '基建处', notes: '修缮验收' },
      { milestone: ProjectMilestone.Audit, date: '2024-09-10', operator: '审计处', notes: '审计完成' },
      { milestone: ProjectMilestone.Transfer, date: '2024-09-20', operator: '资产处', notes: '进入待归档' },
    ],
    attachments: [
      { id: 'ATT-2024-001-1', name: '竣工验收报告.pdf', type: 'acceptance', uploadDate: '2024-08-20', uploadedByDept: '基建处', reviewStatus: 'Approved' as any },
      { id: 'ATT-2024-001-2', name: '审计报告.pdf', type: 'audit', uploadDate: '2024-09-10', uploadedByDept: '审计处', reviewStatus: 'Approved' as any },
      { id: 'ATT-2024-001-3', name: '施工合同.pdf', type: 'contract', uploadDate: '2024-04-25', uploadedByDept: '招标办', reviewStatus: 'Approved' as any },
    ],
    splitItems: [
      { id: 'SPLIT-2024-001-1', category: AssetCategory.Other, name: '屋面防水修缮', amount: 5520000, depreciationYears: 10, depreciationMethod: 'StraightLine' as any },
    ],
    gaojibiaoData: {
      assetName: '综合体育馆（修缮）',
      originalValue: 5520000,
      residualRate: 0.05,
      serviceLife: 10,
      department: '体育部',
      floorCount: 0,
    ...
    roomFunctionPlanConfirmedAt: '2024-09-18T09:00:00.000Z',
