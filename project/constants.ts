...
export const MOCK_PROJECTS: Project[] = [
  ...
  // New Mock Data for Teacher Apartment
  {
    id: 'PRJ-2021-015',
    name: '旗山校区教师公寓1号楼',
    contractAmount: 35000000,
    auditAmount: 33500000,
    auditReductionRate: 4.29,
    finalAmount: 33500000,
    contractor: '福建省第一建筑工程公司',
    status: AssetStatus.Archived,
    ...
    floorCount: 15,
    roomCount: 120,
    plannedStartDate: '2019-05-01',
    plannedEndDate: '2021-07-31',
    projectManager: '郑工',
    supervisor: '福州工程建设监理有限公司',
    isArchived: true,
    isOverdue: false,
    milestones: [],
    attachments: [],
    splitItems: [
      { id: 'SPLIT-TA-1', category: AssetCategory.Building, name: '文博苑教师公寓主体', amount: 33500000, area: 18000, depreciationYears: 50, depreciationMethod: 'StraightLine' as any, assetCardNo: 'FW-2021-0210' },
    ],
    roomFunctionPlan: Array.from({ length: 120 }, (_, i) => {
      const floor = Math.floor(i / 8) + 1;
      const roomNum = (i % 8) + 1;
      const roomType = i % 3 === 0 ? '一室一厅' : (i % 3 === 1 ? '两室一厅' : '三室一厅');
      const area = roomType === '一室一厅' ? 60 : (roomType === '两室一厅' ? 90 : 120);
      return {
        id: `RFP-TA-${floor}-${100 + roomNum}`,
        buildingName: '旗山校区教师公寓1号楼',
        roomNo: `${floor}-${floor}0${roomNum}`,
        area: area,
        mainCategory: 'LifeService',
        subCategory: 'StaffTurnover',
        remark: roomType,
      };
    }),
  ...
  // New Mock Data for Student Dormitory
  {
    id: 'PRJ-2020-007',
    name: '和园5号楼（C5）',
    contractAmount: 28000000,
    auditAmount: 27100000,
    auditReductionRate: 3.21,
    finalAmount: 27100000,
    contractor: '中建海峡建设发展有限公司',
    status: AssetStatus.Archived,
    ...
    floorCount: 10,
    roomCount: 200,
    plannedStartDate: '2018-09-01',
    plannedEndDate: '2020-07-31',
    projectManager: '吴工',
    ...
    attachments: [],
    splitItems: [
      { id: 'SPLIT-SD-1', category: AssetCategory.Building, name: '和园5号楼（C5）主体', amount: 27100000, area: 22000, depreciationYears: 50, depreciationMethod: 'StraightLine' as any, assetCardNo: 'FW-2020-0188' },
    ],
    roomFunctionPlan: Array.from({ length: 200 }, (_, i) => {
      const floor = Math.floor(i / 20) + 1;
      const roomNum = (i % 20) + 1;
      const roomType = i % 3 === 0 ? '八人间' : (i % 3 === 1 ? '六人间' : '四人间');
      const area = roomType === '八人间' ? 40 : (roomType === '六人间' ? 35 : 30);
      return {
        id: `RFP-SD-${floor}-${100 + roomNum}`,
        buildingName: '和园5号楼（C5）',
        roomNo: `${floor}-${floor}0${roomNum}`,
        area: area,
        mainCategory: 'LifeService',
        subCategory: 'StudentDorm',
        remark: roomType,
      };
    }),
    roomFunctionPlanConfirmed: true,
