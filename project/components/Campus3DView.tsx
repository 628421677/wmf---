...
export type Campus3DViewHandle = {
  resetView: () => void;
};
...
const CAMPUS_CENTER_ORIENTATION = {
...
const Campus3DView = forwardRef<Campus3DViewHandle, Campus3DViewProps>(
  ({ onBuildingSelect, mapOverlay = 'none' }, ref) => {
    ...
    const resetView = () => {
      ...
      viewer.camera.flyTo({
        ...
        orientation: CAMPUS_CENTER_ORIENTATION,
        duration: 0.8
      });
    };
...
Campus3DView.displayName = 'Campus3DView';
