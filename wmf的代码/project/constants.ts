...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    attachments: [
      { id: 'ATT-001', name: '立项批复文件.pdf', type: 'approval', uploadDate: '2021-12-05' },
      { id: 'ATT-002', name: '施工合同.pdf', type: 'contract', uploadDate: '2022-02-20' },
      { id: 'ATT-003', name: '竣工验收报告.pdf', type: 'acceptance', uploadDate: '2023-10-20' },
    ],
    splitItems: [
...
export const MOCK_TODOS: TodoItem[] = [
  ...
  { id: 'TODO-003', title: '催缴物理学院超额使用费', module: '公房使用收费', priority: 'Medium', dueDate: '2023-11-20', relatedId: 'FEE-001' },
